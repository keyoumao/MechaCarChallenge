...
plt + geom_boxplot(fill = "white", colour = "#3366FF", linetype = "dotted") + theme(axis.text.x=element_text(angle=45,hjust=1)) #add boxplot and rotate x-axis labels 45 degrees
